...
class ClientRegistry:
    ...
    def on_observation(self, client_id: str, model_id: str) -> bool:
        ...
        if is_new:
            self._clients[client_id] = ClientState(client_id=client_id, model_ids={model_id})
        else:
    ...
    def client_models(self, client_id: str) -> set[str]:
        """Return the set of model IDs this client has used."""
        state = self._clients.get(client_id)
        return state.model_ids if state else set()
